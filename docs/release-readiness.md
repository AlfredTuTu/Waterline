...
| Distribution | Development DMG; guarded cask generator implemented | Signed/notarized DMG, online cask audit/clean installation and signed update/appcast flow |
