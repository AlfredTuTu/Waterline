...
`Scripts/build-icon.sh` derives the standard 16–1024 pixel macOS ICNS representations
from this PNG. `Sources/WaterlineApp/WaterlineMark.swift` draws the matching monochrome
